...
def scenario_param(date_ref, date_scen):
    ...
    folder_path = 'G:/Departement_ R141/Modelisation TIMES/KINESYS output/Attribute CSV/'
...
notebook_urls = ['https://raw.githubusercontent.com/BenjaminTrouve/Kinesys_output/main/Analysis/H2_new_capacity_Kinesys.ipynb']
